Action()
{
	...
	web_url("devt-web", 
		...
		"Url=/devt-service/httpCompImg.do?path=others&code=183&fileName=no.png&timestamp=1682213766362", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		"Url=/devt-service/httpCompImg.do?path=others&code=72881&fileName=no.png&timestamp=1682213766362", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		"Url=/devt-service/httpCompImg.do?path=element-plus&code=1&fileName=no.png&timestamp=1682213766362", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		"Url=/devt-service/httpCompImg.do?path=element-plus&code=breadcrumb1&fileName=1635753774297.png&timestamp=1682213766362", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		"Url=/devt-service/httpCompImg.do?path=element-plus&code=munb&fileName=no.png&timestamp=1682213766362", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		"Url=/devt-service/httpCompImg.do?path=element-plus&code=table0&fileName=1632897923040.png&timestamp=1682213766363", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		"Url=/devt-service/httpCompImg.do?path=element-plus&code=container&fileName=1631004434416.png&timestamp=1682213766363", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		"Url=/devt-service/httpCompImg.do?path=element-plus&code=h5contain1&fileName=1634998089813.png&timestamp=1682213766363", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		"Url=/devt-service/httpCompImg.do?path=element-plus&code=624400&fileName=no.png&timestamp=1682213766363", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		"Url=/devt-service/httpCompImg.do?path=element-plus&code=aq&fileName=no.png&timestamp=1682213766363", "Referer=http://cfgjt.cn:8981/devt-web/", ENDITEM, 
		LAST);
	...
	web_custom_request("list.do_2", 
		...
		EXTRARES, 
		"Url=http://cfgjt.cn:8780/devt-service/websocket.ws?id=mEJ8yj5w6D5c6as3", "Referer=", ENDITEM, 
		LAST);
