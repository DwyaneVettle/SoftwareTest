	...
	web.url(
		{
			...
			extraRes :  [
				...
				{url : '/devt-service/httpCompImg.do?path=element-plus&code=munb&fileName=no.png&timestamp=1682140100238', referer : 'http://cfgjt.cn:8981/devt-web/'},
				{url : '/devt-service/httpCompImg.do?path=element-plus&code=1&fileName=no.png&timestamp=1682140100239', referer : 'http://cfgjt.cn:8981/devt-web/'},
				{url : '/devt-service/httpCompImg.do?path=others&code=72881&fileName=no.png&timestamp=1682140100239', referer : 'http://cfgjt.cn:8981/devt-web/'},
				{url : '/devt-service/httpCompImg.do?path=element-plus&code=breadcrumb1&fileName=1635753774297.png&timestamp=1682140100239', referer : 'http://cfgjt.cn:8981/devt-web/'},
				{url : '/devt-service/httpCompImg.do?path=others&code=183&fileName=no.png&timestamp=1682140100239', referer : 'http://cfgjt.cn:8981/devt-web/'},
				{url : '/devt-service/httpCompImg.do?path=element-plus&code=table0&fileName=1632897923040.png&timestamp=1682140100239', referer : 'http://cfgjt.cn:8981/devt-web/'},
				{url : '/devt-service/httpCompImg.do?path=element-plus&code=624400&fileName=no.png&timestamp=1682140100239', referer : 'http://cfgjt.cn:8981/devt-web/'},
				{url : '/devt-service/httpCompImg.do?path=element-plus&code=aq&fileName=no.png&timestamp=1682140100239', referer : 'http://cfgjt.cn:8981/devt-web/'},
				{url : '/devt-service/httpCompImg.do?path=element-plus&code=container&fileName=1631004434416.png&timestamp=1682140100239', referer : 'http://cfgjt.cn:8981/devt-web/'},
				{url : '/devt-service/httpCompImg.do?path=element-plus&code=h5contain1&fileName=1634998089813.png&timestamp=1682140100239', referer : 'http://cfgjt.cn:8981/devt-web/'}
			]
		}
	);
	...
	web.customRequest(
		{
			...
			extraRes :  [
				{url : 'http://cfgjt.cn:8780/devt-service/websocket.ws?id=fyCxPRTnMcMmmyxP', referer : ''}
			]
		}
	);
