Action()
{
	...
	web_url("devt-web", 
		...
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=input&fileName=1631125196214.png&timestamp=1645022327695", ENDITEM, 
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=span0&fileName=1634020364206.png&timestamp=1645022327695", ENDITEM, 
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=breadcrumb1&fileName=1635753774297.png&timestamp=1645022327696", ENDITEM, 
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=container&fileName=1631004434416.png&timestamp=1645022327696", ENDITEM, 
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=page1&fileName=1635691548643.png&timestamp=1645022327698", ENDITEM, 
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=avatar0&fileName=1635500337608.png&timestamp=1645022327695", ENDITEM, 
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=h5contain1&fileName=1634998089813.png&timestamp=1645022327696", ENDITEM, 
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=password1&fileName=1635185972471.png&timestamp=1645022327699", ENDITEM, 
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=table0&fileName=1632897923040.png&timestamp=1645022327696", ENDITEM, 
		"Url=../devt-service/httpCompImg.do?path=element-plus&code=span1&fileName=1634888248760.png&timestamp=1645022327696", ENDITEM, 
		LAST);
